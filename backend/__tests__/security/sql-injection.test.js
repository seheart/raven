...
describe('SQL Injection Prevention', () => {
  ...
  describe('Prepared Statements', () => {
    it('should use prepared statements for inserts', () => {
      ...
      expect(() => {
        db.insertEvent(timestamp, maliciousInput, 'modified', null, 0, 0, null, null, null, null);
      }).not.toThrow();
    ...
    it('should escape quotes in queries', () => {
      ...
      db.insertEvent(timestamp, maliciousPath, 'modified', null, 0, 0, null, null, null, null);
  ...
  describe('Input Validation', () => {
    it('should handle null bytes in input', () => {
      ...
      expect(() =>
        db.insertEvent(timestamp, inputWithNull, 'modified', null, 0, 0, null, null, null, null)
      ).not.toThrow();
    });
    ...
    it('should handle very long inputs', () => {
      ...
      expect(() =>
        db.insertEvent(timestamp, longInput, 'modified', null, 0, 0, null, null, null, null)
      ).not.toThrow();
    });
    ...
    it('should handle special SQL characters', () => {
      ...
      specialChars.forEach(char => {
        const timestamp = new Date().toISOString();
        const filepath = `test${char}file.js`;
  ...
  describe('Query Results', () => {
    ...
    it('should not allow reading arbitrary tables', () => {
      ...
      db.insertEvent(timestamp, 'test.js', 'modified', null, 0, 0, null, null, null, null);
