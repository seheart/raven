...
describe('Telemetry Integration Tests', () => {
    ...
    test('should handle multiple events in sequence', async () => {
        const events = [
            ...
            { agent: 'agent-1', event: 'file_edit', message: 'Edited file1.js', file: 'file1.js', lines_changed: 5 },
        ...
        const storedEvents = db.db.prepare(`
    ...
    test('should handle concurrent requests', async () => {
        const concurrentRequests = Array(10).fill().map((_, i) => request(app)
            .post('/telemetry')
            .send({
            agent: `agent-${i}`,
...
//# sourceMappingURL=telemetry-flow.test.js.map