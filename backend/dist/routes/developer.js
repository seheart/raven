...
export function createDeveloperRoutes(deps) {
    ...
    router.get('/interactions', (req, res) => {
        try {
            ...
            const interactions = developerDB.getRecentInteractions(parseInt(limit), project === 'null' || project === 'all' ? null : project);
    ...
    router.get('/patterns', (req, res) => {
        try {
            ...
            const patterns = developerDB.getCodingPatterns(language === 'null' || language === 'all' ? null : language, parseInt(limit));
