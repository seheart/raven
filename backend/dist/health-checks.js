...
class HealthCheckSystem {
    ...
    createFailureNotification(checkName, message, category) {
        ...
        try {
            ...
            this.db.createNotification(notification.type, notification.severity, notification.title, notification.message, notification.metadata);
...
function createDefaultHealthChecks(db, io) {
    ...
    healthCheck.registerCheck('Database Connection', 'database', async () => {
        try {
    ...
    healthCheck.registerCheck('Events Table', 'database', async () => {
        try {
    ...
    healthCheck.registerCheck('Agent Events Table', 'database', async () => {
        try {
    ...
    healthCheck.registerCheck('Notifications Table', 'database', async () => {
        try {
    ...
    healthCheck.registerCheck('Dashboard Stats Query', 'data', async () => {
        try {
    ...
    healthCheck.registerCheck('Recent File Events Query', 'data', async () => {
        try {
    ...
    healthCheck.registerCheck('Agent Stats Query', 'data', async () => {
        try {
    ...
    healthCheck.registerCheck('WebSocket Server', 'websocket', async () => {
        try {
            if (!io) {
    ...
    healthCheck.registerCheck('System Metrics Collection', 'system', async () => {
        try {
