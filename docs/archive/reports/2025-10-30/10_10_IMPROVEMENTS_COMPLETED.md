...
**Week 2:** 4. Create ServerBootstrap class 5. Move all config to files 6. Add 20 security tests

**Week 3:** 7. Performance regression test suite 8. Chaos engineering tests 9. Update 10/10 tracker
