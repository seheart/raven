...
--surface-2: /* Hover states, secondary surfaces */
...
--accent-2: /* Secondary accent (gradients) */
...
--pill-success: /* Green pills (additions) */
--pill-error: /* Red pills (deletions) */
--pill-mod: /* Yellow pills (modifications) */
```
...
**Source**: `/home/seth/Projects/raven/brand/raven_style_guide.html`
