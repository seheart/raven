  ...
  const VARIANTS = [
    {
      ...
      cls: 'variant-1c',
      name: 'Phosphor Green',
      tag: '★ current Raven baseline · Bloomberg · CRT'
    },
    { id: '1a', cls: 'variant-1a', name: 'Pure Mono', tag: 'no accent · falls back to grey' },
    {
      id: '1b',
      cls: 'variant-1b',
      name: 'Steel Iridescence',
      tag: 'cool blue-grey · raven-feather realistic'
    },
    { id: '1d', cls: 'variant-1d', name: 'Amber Terminal', tag: 'BBS warmth · VT100 nostalgia' },
    {
      id: '1e',
      cls: 'variant-1e',
      name: 'Restrained Violet',
      tag: 'Foundry callback · dialed down'
    },
    {
      id: '1f',
      cls: 'variant-1f',
      name: 'Crimson Wax',
      tag: 'single dramatic red · used sparingly'
    }
  ];
</script>
...
<PageLayout>
  <div class="space-y-12">
    ...
    <!-- Hero — full-width prose (variant jump-nav aside removed). -->
    <section class="max-w-[48rem]">
      ...
      <p class="mt-4 text-base text-body font-sans leading-relaxed">
        Six accent treatments on top of V01 Terminal //. The base palette (black canvas, grey
        surfaces, near-white headings) stays the same across all six — only the brand accent shifts.
        Toggle the theme to see how each behaves in light and dark.
      </p>
    </section>
    ...
    <PageSection title="07 // Pick one">
      <p class="text-base text-body font-sans leading-relaxed">
        Tell me which accent you want to lock in. The base black palette stays either way; only the
        brand accent and primary CTAs change. <strong>1a</strong> stays where we are;
        <strong>1b</strong>–<strong>1f</strong> add a single distinguishing color without taking over.
      </p>
    </PageSection>
  </div>
</PageLayout>
